...
import { ComposeColumns } from "./AmenitiesListColumns";
import {
  toggleAllColumns,
  toggleColumn,
  exportToCSV,
...
const AmenityPage = () => {
  ...
  const handleOnCSVExport = () => {
    exportToCSV("Amenities", columns, amenities);
  };
  return (
    <>
      <AmenityDrawer
          ...
          <PageCard
            ...
            table={
              isLoading || isFetching ? (
                ...
                <AdminTable
                  noDataMessage="There are no Amenities"
                  searchText={searchText}
                  columns={columns}
                  loading={isLoading}
                  data={amenities?.entities}
                  dataCount={amenities?.ids?.length}
                  onRowClick={(ev, row) => {
