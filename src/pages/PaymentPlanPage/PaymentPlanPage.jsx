...
import { ComposeColumns } from "./PaymentPlanListColumns";
import {
  toggleAllColumns,
  toggleColumn,
  exportToCSV,
...
const PaymentPlanPage = () => {
  ...
  const handleOnCSVExport = () => {
    exportToCSV("PaymentPlans", columns, paymentPlans);
  };
  return (
    <>
      <PaymentPlanDrawer
          ...
          <PageCard
            ...
            table={
              isLoading || isFetching ? (
                ...
                <AdminTable
                  noDataMessage="There are no PaymentPlans"
                  searchText={searchText}
                  columns={columns}
                  loading={isLoading}
                  data={paymentPlans?.entities}
                  dataCount={paymentPlans?.ids?.length}
                  onRowClick={(ev, row) => {
