...
import { ComposeColumns } from "./CurrenciesListColumns";
import {
  toggleAllColumns,
  toggleColumn,
  exportToCSV,
...
const CurrenciesPage = () => {
  ...
  const handleOnCSVExport = () => {
    exportToCSV("Currencies", columns, currencies);
  };
  return (
    <>
      <CurrenciesDrawer
          ...
          <PageCard
            ...
            table={
              isLoading || isFetching ? (
                ...
                <AdminTable
                  noDataMessage="There are no Currencies"
                  searchText={searchText}
                  columns={columns}
                  loading={isLoading}
                  data={currencies?.entities}
                  dataCount={currencies?.ids?.length}
                  onRowClick={(ev, row) => {
