...
import { ComposeColumns } from "./DevelopersListColumns";
import {
  toggleAllColumns,
  toggleColumn,
  exportToCSV,
...
const DeveloperPage = () => {
  ...
  const handleOnCSVExport = () => {
    exportToCSV("Developers", columns, developers);
  };
  return (
    <>
      <DeveloperDrawer
          ...
          <PageCard
            ...
            table={
              isLoading || isFetching ? (
                ...
                <AdminTable
                  noDataMessage="There are no Developers"
                  searchText={searchText}
                  columns={columns}
                  loading={isLoading}
                  data={developers?.entities}
                  dataCount={developers?.ids?.length}
                  onRowClick={(ev, row) => {
